module NavHelper
  ...
  def configure_nav_items
    [
      ...
      {:id => :home,        :label => 'Home',       :url => root_path,                  :placement => :top,  :title => 'Home Page'},
      {:id => :example,     :label => 'Example',    :url => placeholder_path(:example), :placement => :top, :title => 'Placeholder Example Page'},
      {:id => :help,        :label => 'Help',       :url => help_path,                  :placement => :top},
      #nav items for :footer
      {:id => :help,        :label => 'Help',       :url => help_path,                  :placement => :footer},
    ]
  end
